...
function About_landing() {
  return (
  <div className="gilroy  relative text-center flex items-center justify-center   flex-col text-4xl text-[#8B276F] font-bold h-screen w-full  p-19">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="h-34 w-60 bg-red-50 absolute top-30 left-25 rounded-2xl -rotate-4 overflow-hidden"
        >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="h-34 w-60 bg-red-50 absolute top-30 right-25 rounded-2xl rotate-4 overflow-hidden"
        >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="h-34 w-60 bg-red-50 overflow-hidden absolute top-125 left-30 rounded-2xl rotate-4"
        >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="h-34 w-60 bg-red-50 absolute top-125 right-30 rounded-2xl -rotate-4 overflow-hidden"
        >
        ...
        >
          <p className="text-xl inter font-medium w-[60%] mt-2">
