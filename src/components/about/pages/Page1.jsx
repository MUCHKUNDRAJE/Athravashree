...
function Page1({logoref, titleref}) {
  return (
   <div  className='inter min-h-screen flex flex-col-reverse overflow-hidden  md:flex md:flex-row md:pt-20 w-full '>
        <div className=' -mt-20 md:mt-0 font-bold  md:p-20 h-[80vh] flex items-start justify-center flex-col w-full  md:w-1/2 text-[#8B276F] '>
                <h1 className=' gilroy px-10 font-bold text-4xl md:text-8xl   text-[#8B276F] ' >
           ...
           <div className='h-[50vh] mt-30 md:mt-0 md:mb-20 md:h-[80vh] w-full  md:w-1/2 bg-[url(https://i.pinimg.com/736x/a9/51/f2/a951f29e0158851d8486c0ab2348fe8d.jpg)] relative flex items-start justify-center '>
