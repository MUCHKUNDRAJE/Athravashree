...
function Page2() {
  ...
  return (
    <div className='h-screen w-full mb-40 md:mb-0  flex md:flex-row flex-col items-center justify-center '>
        <h1 className='gilroy font-bold w-full mt-40 text-3xl  text-center bg-[#8B276F] text-white p-2 rounded md:hidden block  '>Our Founders Vision</h1>
        <div className='h-screen md:w-1/2  flex items-center justify-center' >
             <div className='h-[70%] rounded-2xl w-full  md:w-[90%] bg-amber-300 overflow-hidden relative'>
         ...
         <div className='h-screen md:mb-0  md:w-1/2 flex items-center justify-center ' >
                     
                    <div className='px-4 md:px-0 text-center md:text-start md:mb-0 mb-20  md:w-[70%] flex flex-col items-center justify-center'>
                           <h1 className='gilroy hidden md:block font-bold text-3xl mb-4 bg-[#8B276F] text-white p-2 rounded  '>Our Founders Vision</h1>
                     <i className='inter  '>
